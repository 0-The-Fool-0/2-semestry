...
bool compareOtdelenie(const Element1& a, const Element1& b) {
...
void findStudentsByKurs(const MASSIV<Element3>& students, int kurs) {
    cout << "students " << kurs << " kurs" << endl;
    bool found = false;
    ...
    if (!found) {
        cout << "students " << kurs << " of kurs are not found." << endl;
    }
}
template <typename T>
void findStudentsByKurs1(const MASSIV<T>& students, int K1) {
    cout << "students " << K1 << endl;
    bool found = false;
    for (size_t i = 0; i < students.getSize(); i++) {
        if (students[i] == K1) {
            cout << students[i] << endl;
    ...
    if (!found) {
        cout << "students " << K1 << " of kurs are not found." << endl;
    }
}
int main() {
    MASSIV<Element1> students1(4);
    MASSIV<Element2> students2(4);
    MASSIV<Element1> students1b(5);
    MASSIV<Element2> students2b(4);
    ...
    students2b.readBinary("students2.bin");
    cout << "students1 : " << endl << students1b << endl;
    cout << "students2 : " << endl << students2b << endl;
    sortMassiv(students1, compareOtdelenie);
    ...
    int K;
    cout << "findStudentsByKurs ";
    cin >> K; 
    findStudentsByKurs(students3, K);
